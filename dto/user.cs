...
namespace dto
{
    public class User
    {
        ...
        public void SetUser(Guid uid, string nome, string cognome, string codice_fiscale, DateTime? data_nascita, DateTime? data_rilascio_porto_armi, string numero_porto_armi, string cap_nascita, string comune_nascita, string provincia_nascita, string indirizzo_residenza, string cap_residenza, string comune_residenza, string provincia_residenza, string sezione, string provincia, DateTime? data_pagamento, string numero, string tipo, string telefono, string cellulare_whatsapp, string mail)
        {
            this.Uid = uid;
            this.Nome = nome;
